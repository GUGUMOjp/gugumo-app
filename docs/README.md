...
Company / Workspace / Profile のSQL Draft、Migration管理方針、index、RLS、rollback下書き。
...
### 20_[ReleaseEpic9UiPolish.md](http://ReleaseEpic9UiPolish.md)

営業デモ・初期リリース向けのUI統一、導線改善、レスポンシブ方針。
